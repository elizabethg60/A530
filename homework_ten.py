...
plt.ylabel("extinction coefficient (1/cm)", fontsize = 12)
...
plt.plot(wavelength_arr_ang, np.array(first_line_opacities)*(4*np.pi), linewidth = 2, label = 'λ = 5889.95', color = 'r')
plt.plot(wavelength_arr_ang, np.array(second_line_opacities)*(4*np.pi), linewidth = 2, label = 'λ = 5895.924', color = 'g')
plt.plot(wavelength_arr_ang, continuous_opacities, linewidth = 2, label = 'continuous', color = 'k')
plt.xlabel("wavelength [Å]", fontsize = 12)
plt.ylabel("opacity (1/cm)", fontsize = 12)
plt.xticks(fontsize = 12) 
plt.yticks(fontsize = 12) 
plt.legend(fontsize = 12)
plt.legend()
