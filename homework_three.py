...
plt.xscale("log")
plt.legend()
plt.savefig("Figures/hw_three_figures/sample_5bi.png", bbox_inches='tight')
plt.show()
...
plt.xscale("log")
plt.legend()
plt.savefig("Figures/hw_three_figures/sample_5bii.png", bbox_inches='tight')
plt.show()
...
plt.xscale("log")
plt.legend()
plt.savefig("Figures/hw_three_figures/sample_5biii.png", bbox_inches='tight')
plt.show()
